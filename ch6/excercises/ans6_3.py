...
class TextBook(Book):  # 从Book类继承
    """TextBook(教材类)是普通书籍类的一个子类
       从Book类继承
    """
    def __init__(self, name, author, isbn, price, publisher="ABC Press", courseware=13, exercise=200):
    ...
    def info(self):
        super().info()
        print(f"The book's courseware:{self.courseware}; exercise:{self.exercise}")

# 实例化一个python_textbook对象，并调用info()方法，输出信息
python_textbook = TextBook('Python TextBook', 'Amy Chen', '978-7-111-64598-6', 89.00, "XYZ Press", 20, 300)
